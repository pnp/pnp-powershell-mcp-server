...
| `PNP_MCP_MAX_OUTPUT_CHARS` | `50000` | Largest tool response returned, in characters. Longer output is truncated to its first whole lines with a note saying how much was dropped. Values below 500 are ignored. |
